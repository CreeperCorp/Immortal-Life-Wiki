print('Only Season 9 & 10 are included right now')

print("Currently Season 10's rules are the same as Season 9's")
...
if seasonIs? == '10':
  ...
  if (ifLore10 == 'yes'):
    print("No important stuff has happened")
  ifVideos10 = input('Do you want to see Season 10 videos in chronological order?(yes/no): ')
    
  if (ifVideos10 == 'yes'):
    print('CreepSplotin: E')
    
  ifLive10 = input('Do you want to see Season 10 live streams in chronological order?(yes/no): ')
    
  if (ifLive10 == 'yes'):
    print('CreepSplotion: The First Day | 20 hours')
  ...
  if (ifHeartCountS10 == 'yes'):
    print('270 Hearts In Circulation')
    print('CreepSplotion: 10 Hearts')
    print('ReapSplotion: 10 Hearts')
    print('Ennard: 10 Hearts')
    print('Division: 10 Hearts')
    print('Giggles: 10 Hearts')
    print('CreepYT: 10 Hearts')
    print('Dash: 10 Hearts')
    print('XxFun: 10 Hearts')
    print('Finxlly: 10 Hearts')
    print('PolyPeptide: 10 Hearts')
    print('Quilver: 10 Hearts')
    print('Batchi: 10 Hearts')
    print('Joc3e: 10 Hearts')
    print('R3zzignation: 10 Hearts')
    print('R3zz0lution: 10 Hearts')
    print('XRayz: 10 Hearts')
    print('aXc3L: 10 Hearts')
    print('UnScr3pted: 10 Hearts')
    print('Bee: 10 Hearts')
    print('Vee: 10 Hearts')
  ...
  ifStrengthCountS10 = input("Do you want to see everyone's strength count in S9?(yes/no): ")

  if (ifStrengthCountS10 == 'yes'):
    print('54 Obtainable Strength In Circulation')
    print('CreepSplotion: 3 Strength')
    print('ReapSplotion: 3 Strength')
    print('Ennard: 3 Strength')
    print('Division: 3 Strength')
    print('Giggles: 3 Strength')
    print('CreepYT: 3 Strength')
    print('Dash: 3 Strength')
    print('XxFun: 3 Strength')
    print('Finxlly: 3 Strength')
    print('PolyPeptide: 3 Strength')
    print('Quilver: 3 Strength')
    print('Batchi: 3 Strength')
    print('Joc3e: 3 Strength')
    print('R3zzignation: 3 Strength')
    print('R3zz0lution: 3 Strength')
    print('XRayz: 3 Strength')
    print('aXc3L: 3 Strength')
    print('UnScr3pted: 3 Strength')
  ...
  ifTeamsS10 = input("Do you want to see the teams on IMMRTLLS10?(yes/no): ")
...
if seasonIs? == '9':
  ...
  if (ifLive9 == 'yes'):
    ...
    print("Quotient: Joining After A War | 11/15/25 | 8 hours")
    print("P0ly: Everyone's Gone Till Monday | 11/16/25 | 24 hours")
  
  ifHeartCountS9 = input("Do you want to see everyone's heart count in S9?(yes/no): ")
  
  if (ifHeartCountS9 == 'yes'):
    print('325 Hearts In Circulation')
    print('CreepSplotion: 2 + 47 Hearts')
    print('ReapSplotion: 10 Hearts')
    print('Ennard: 0 + 0 Hearts (BANNED)')
    print('Division: 20 Hearts')
    print('Giggles: 20 + 9 Hearts')
    print('CreepYT: 20 + 17 Hearts')
    print('Dash: 8 Hearts')
    print('XxFun: 10 Hearts')
    print('Finxlly: 1 Hearts')
    print('PolyPeptide: 20 + 0 Hearts')
    print('Quilver: 1 Hearts')
    print('Batchi: 2 Hearts')
    print('Joc3e: 2 Hearts')
    print('R3zzignation: 20 + 0 Hearts')
    print('R3zz0lution: 20 + 3 Hearts')
    print('XRayz: 11 Hearts')
    print('aXc3L: 20 Hearts')
    print('UnScr3pted: 14 Hearts')
    print('Bee: 3 Hearts')
    print('Vee: 3 Hearts')
  ...
  if (ifStrengthCountS9 == 'yes'):
    print('71 Obtainable Strength In Circulation')
    print('CreepSplotion: 5 + 1 Strength')
    ...
    print('R3zz0lution: 5 + 8 Strength')
    print('XRayz: 5 + 0 Strength')
    print('aXc3L: 5 Strength')
    print('UnScr3pted: 1 Strength')
    print('Bee: 1 Strength')
    print('Vee: 1 Strength')
