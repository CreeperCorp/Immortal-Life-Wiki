...
if (ifLore == 'yes'):
  ...
  print("The third war begins with CreepSplotion killing XRayz to initiate the war. P0ly then 2v1s Finxlly & Quilver which he is scripted to lose by getting drained. R3zz0 then kills Batchi, Joc3e, Bee, Vee, & UnScr1pted because he hasn't revealed he's teamed with P0lyR3zzzz. P0ly then loses his 2v1 as his armor breaks (He was using a backup set with only prot 2 and no unbreaking or mending). R3zz0 forgets he's meant to die to another player to make it seem less suspicious and dies to fall damage (All his stuff despawn).")
...
if (ifHeartCountS9 == 'yes'):
  ...
  print('R3zz0lution: 20 + 5 Hearts')
  print('XRayz: 12 Hearts')
  print('aXc3L: 8 Hearts')
  print('UnScr3pted: 15 Hearts')
  print('Bee: 9 Hearts')
  print('Vee: 9 Hearts')
  print('ClockWise: 20 + 0 Hearts')
  print('Velocity: 15 Hearts')
...
if (ifStrengthCountS9 == 'yes'):
  ...
  print('R3zz0lution: 5 + 9 Strength')
  print('XRayz: 5 + 1 Strength')
  print('aXc3L: 5 Strength')
  print('UnScr3pted: 1 Strength')
  print('Bee: 2 Strength')
  print('Vee: 2 Strength')
  print('ClockWise: 5 + 2 Strength')
