...
if (ifLore == 'yes'):
  ...
  print("The third war begins with CreepSplotion killing XRayz to initiate the war. P0ly then 2v1s Finxlly & Quilver which he is scripted to lose by getting drained. R3zz0 then kills Batchi, Joc3e, Bee, Vee, & UnScr1pted because he hasn't revealed he's teamed with P0lyR3zzzz.")
...
if (ifStrengthCountS9 == 'yes'):
  ...
  print('R3zz0lution: 5 + 10 Strength')
